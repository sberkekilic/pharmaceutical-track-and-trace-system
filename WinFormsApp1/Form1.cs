...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("select * from AnaTablo", baglan);
            SqlCommand komut2 = new SqlCommand("select * from ToplamStok", baglan);
